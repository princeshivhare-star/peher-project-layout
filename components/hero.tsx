          ...
          <div className="relative z-20 flex flex-col items-start text-left lg:translate-x-4 xl:translate-x-6">
            ...
            <div className="flex w-full flex-col items-start lg:w-fit">
              ...
              <div className="mt-6 flex w-full items-start justify-between gap-6">
                <p className="text-[1.25rem] font-normal leading-[0.86] tracking-[-0.045em] text-foreground sm:text-[1.45rem] lg:text-[1.7rem]">
                  Visual &amp;
                  <br />
                  Brand Identity
                  <br />
                ...
                <p className="text-left text-[1.25rem] font-normal leading-[0.86] tracking-[-0.045em] text-foreground sm:text-[1.45rem] lg:text-[1.7rem] xl:text-[1.7rem]">
                  Emerging
                  <br />
                  designer
                </p>
            ...
            <div className="w-full lg:w-[500px] xl:w-[530px]">
              ...
              {/* Buttons */}
              <div className="mt-8 grid w-full grid-cols-1 gap-3 sm:grid-cols-2 sm:gap-6 lg:mt-10">
                <Link
                  href="/#projects"
                  className="group inline-flex min-h-12 items-center justify-center gap-3 rounded-lg border border-blue-brand bg-blue-brand px-4 text-sm font-normal text-white shadow-[0_10px_28px_rgba(108,147,255,0.18)] transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_16px_34px_rgba(108,147,255,0.25)] md:text-base"
                >
                ...
                <Link
                  href="/#contact"
                  className="group inline-flex min-h-12 items-center justify-center gap-3 rounded-lg border border-foreground bg-foreground px-4 text-sm font-normal text-background shadow-[0_10px_28px_rgba(40,38,33,0.12)] transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_16px_34px_rgba(40,38,33,0.18)] md:text-base"
                >
