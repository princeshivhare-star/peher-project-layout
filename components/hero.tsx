...
export function Hero() {
  return (
    ...
    >
      <div className="absolute right-0 top-20 h-80 w-80 rounded-full bg-lilac-brand/20 blur-3xl" />
      <div className="absolute bottom-10 left-10 h-72 w-72 rounded-full bg-yellow-brand/20 blur-3xl" />
      ...
      <div className="relative mx-auto grid max-w-6xl items-center gap-12 lg:grid-cols-[0.95fr_1.05fr]">
        <div className="text-center lg:text-left">
          ...
          <p className="mx-auto mt-7 max-w-xl text-base leading-relaxed text-muted-foreground text-pretty md:text-lg lg:mx-0">
